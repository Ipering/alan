...
<div class="btn-toolbar">
    <a href="orderState.php" class="btn">返回列表</a>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">订单详细信息</a></li>
    </ul>
      ...
      <?php
              ...
              if ($result) {
                  ...
                  while($row =$result->fetch_array()){//循环输出结果集中的记录
                    $query_c_id = "select C_name from tourc where C_id='$row[1]'";
                    $result_c_id= $conn->query($query_c_id);
                    $row_c_name = $result_c_id->fetch_array();
            ?>
    <form id="tab" action="#" method="post">
        <label>公司名</label>
        <input type="text" class="input-xlarge" disabled="true" value="<?php echo $row_c_name[0] ?>">
        <label>旅游路线编号</label>
