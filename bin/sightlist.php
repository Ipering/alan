...
<html lang="en">
  <head>
    ...
    <script src="lib/jquery-1.8.1.min.js" type="text/javascript">
    </script>
        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <ul id="accounts-menu" class="nav nav-list collapse in">
                  <li class="active"><a href="sightlist.php">景点信息列表</a></li>
...
<div class="well search-well">
        <form class="form-inline" method="post" action="sightlist.php">

            <input class="input-xlarge" placeholder="Search Help..." id="appendedInputButton" type="text" name="search_sl">
...
<div class="row-fluid">
    <div class="block">
        <div class="block-heading" data-toggle="collapse" data-target="#tablewidget">景点列表</div>
        ...
        if($keyword==""){ 
$sql="select * from viewspot limit $page $pageSize";
}
else{
        ...
        $result1 = $conn->query($sql);
			...
			?>
                <tr>
                  ...
                  <?php $URL_sl = "changesight.php?".$row[0];
				  		$URL_sl_del = "info_php/delsight.php?".$row[0]; ?>
                  
                  <td>
              <a href="<?php echo $URL_sl; ?>"><i class="icon-pencil"></i></a>
              <a href="<?php echo $URL_sl_del; ?>" onclick="return window.confirm('确定删除吗？');" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
                </tr>
				<?php
										   }
...
?>
    ...
    <?php
        ...
        ?>
        <li><a href="sightlist.php?page=<?php echo $pageval-1?>">Prev</a></li>
        <li><a href="sightlist.php?page=<?php echo @$pageval+1?>">Next</a></li>
    </ul>
</div>
</div>
