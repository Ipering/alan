        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <ul id="accounts-menu" class="nav nav-list collapse in">
                    ...
                    <li class="active"><a href="FhistoryOrder.php">历史订单列表</a></li>
                </ul>
            </div>
        </div>
        <div class="span9">
...
<div class="well search-well">
        ...
        <form class="form-inline" method="post" action="FhistoryOrder.php">

            <input class="input-xlarge" placeholder="Search Help..." id="appendedInputButton" type="text" name="search_fho">
    ...
    <div class="block">
        ...
        <div id="tablewidget" class="block-body collapse in">
            <table class="table">
              ...
              $keyword=@trim($_POST["search_fho"]); 
              //检查是否为空 
              if($keyword==""){ 
              $query="select * from form where (C_id='$C_id') and (F_state>2)";
              }
              else{
                  $query="select * from form where (C_id='$C_id') and (R_name like '%".$keyword."%') and (F_state>2)";
                }
        ...
        if($keyword==""){ 
              $sql="select * from form where (C_id='$C_id') and (F_state>2)";
              }
              else{
                  $sql="select * from form where (C_id='$C_id') and (R_name like '%".$keyword."%') and (F_state>2)";
                }
...
?>
    ...
    <?php
        ...
        ?>
        <li><a href="FhistoryOrder.php?page=<?php echo $pageval-1?>">Prev</a></li>
        <li><a href="FhistoryOrder.php?page=<?php echo @$pageval+1?>">Next</a></li>
    </ul>
</div>
</div>
